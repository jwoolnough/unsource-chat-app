    ...
    <div ref={menuRef}>
      ...
      >
        <button
          ...
          type="button"
          className={clsxm(
            "absolute right-1.5 top-3 flex h-6 w-8 items-center justify-end bg-gradient-to-l from-orange-400 via-orange-400 via-70% pr-1.5 text-orange-200 opacity-0 transition hover:text-white group-hover:opacity-100",
            isOpen && "opacity-100"
          )}
          aria-label="More"
        >
